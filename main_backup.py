...
class RealtimeRecognizer:
    ...
    def run(self) -> None:
        ...
        window_width = int(self.screen_width * 0.99)  # 99% of screen width
        ...
        screen_x = (self.screen_width - window_width) // 2
        screen_y = (self.screen_height - window_height) // 2
        cv2.moveWindow(WINDOW_TITLE, screen_x, screen_y)
        ...
        while True:
            ...
            # Draw controls on the right side (adjust for centered frame)
            control_y = 40
            control_x = window_width - 250
            # Controls header
            cv2.putText(frame, "CONTROLS:", (control_x, control_y), cv2.FONT_HERSHEY_SIMPLEX, 
            ...
            controls = [
                ...
                ("Go on:", "localhost 5000:/performance.html", (255, 165, 0))
            ]
            for i, (key, action, color) in enumerate(controls, 1):
                ...
                # Use smaller font for the long URL text
                if i == 6:  # The "Go on:" control item
                    cv2.putText(frame, f"{action}", (control_x + 100, y), 
            ...
            cv2.putText(frame, 'Text:', (20, label_y), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,255,0), 2, cv2.LINE_AA)
                        ...
                        if hold_time > 2.0 and self.extra_letters_added == 0:
                            ...
                            if self.full_duplex and self.sio and self.sio.connected:
                                try:
                                    ...
                                    print(f"[WebSocket] Sent extra letter (2s): '{maj_label}' with emotion: {emotion_data}")
                                except Exception as e:
                                    pass
                        ...
                        # Add third letter at 4 seconds
                            ...
                            if self.full_duplex and self.sio and self.sio.connected:
                                try:
                                    ...
                                    print(f"[WebSocket] Sent extra letter (4s): '{maj_label}' with emotion: {emotion_data}")
                                except Exception as e:
                                    pass
            else:
            ...
            if key == 27:
                ...
                if text:
                    ...
                    self.display_correction_until = time.time() + 3.0  # Display for 3 seconds
